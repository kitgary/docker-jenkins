...
ARG DOCKER_ENGINE=1.11.2
ARG DOCKER_COMPOSE=1.7.1

# Install base packages
RUN apt-get update -y && \
    apt-get install apt-transport-https curl python-dev python-setuptools gcc make -y libssl-dev && \
    easy_install pip
...
RUN apt-key adv --keyserver hkp://pgp.mit.edu:80 --recv-keys 58118E89F3A912897C070ADBF76221572C52609D && \
    ...
    apt-get install docker-engine=${DOCKER_ENGINE:-1.11.2}-0~trusty -y && \
